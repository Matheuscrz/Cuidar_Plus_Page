  ...
  const features = [
    {
      ...
      desc: "Sensores de alta precisão para detectar febre instantaneamente.",
    },
    {
    ...
    },
    {
      ...
      desc: "Monitoramento da saturação de oxigênio no sangue.",
    },
    {
    ...
    },
    {
      ...
      desc: "Gere PDFs detalhados para compartilhar com o médico.",
    },
  ];
